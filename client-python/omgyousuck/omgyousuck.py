...
# the OMGYOUSUCK implements simple heuristics 
# when playing the WEREWOLF role:
# - At the start of each day, decides a random villager to vote
# - Estimates this villager as a werewolf, announces vote against him
#   and start requesting others to to the same
# - If some other agent votes or estimates against him, set this
#   agent as current target and estimates/votes/requests on him
# - If any other agents act agressively against him, save them in 
#   a queue as future targets
